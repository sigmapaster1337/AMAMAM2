...
CVar(SentryAmmo, "Sentrygun bullets", Color_t(255, 255, 255, 255));
CVar(SentryRockets, "Sentrygun rockets", Color_t(255, 255, 255, 255));
...
CVar(HitboxFade, "Hitbox fade", false, VISUAL);
CVar(HitboxFadeSpeed, "Hitbox fade speed", 2.f, VISUAL | SLIDER_MIN | SLIDER_PRECISION, 0.1f, 10.f, 0.1f);

CVar(SpellFootstep, "Spell footstep color", Color_t(255, 255, 255, 255), VISUAL);

CVar(LineBox, "Line box", false, VISUAL);  // Toggle for the box

CVar(LineBoxEdge, "Line box edge color", Color_t(255, 255, 255, 255), VISUAL);
CVar(LineBoxEdgeIgnoreZ, "Line box edge ignore Z color", Color_t(255, 255, 255, 0), VISUAL);

CVar(LineBoxFace, "Line box face color", Color_t(255, 255, 255, 60), VISUAL);
CVar(LineBoxFaceIgnoreZ, "Line box face ignore Z color", Color_t(255, 255, 255, 0), VISUAL);
...
CVar(Enabled, "Enabled", true, NOSAVE | DEBUGVAR);
CVar(DrawDuration, "Draw duration", 5.f, SLIDER_MIN | SLIDER_PRECISION, 0.1f, 10.f, 0.1f);
CVar(Fadeout, "Fadeout time", 2.f, SLIDER_CLAMP | SLIDER_PRECISION, 0.f, 10.f, 0.1f);  // Recommended default 2s
NAMESPACE_END(Line)
...
CVar(DoubleTickBase, "Double tickbase", false);
...
NAMESPACE_BEGIN(ChatTranslator, Chat Translator)
CVar(Enabled, VA_LIST("Enabled", "Chat Translator"), false);
CVarValues(TargetLanguage, "Target language", 0, NONE, nullptr,
	VA_LIST("English(en)", "Russian(ru)", "German(de)", "French(fr)", "Spanish(es)", "Portuguese(pt)",
		"Chinese (Simplified)(zh)", "Chinese (Traditional)(zh-tw)", "Japanese(ja)", "Korean(ko)",
		"Turkish(tr)", "Polish(pl)", "Italian(it)", "Dutch(nl)", "Swedish(sv)", "Norwegian(no)",
		"Danish(da)", "Finnish(fi)", "Czech(cs)", "Romanian(ro)", "Hungarian(hu)", "Ukrainian(uk)",
		"Arabic(ar)", "Thai(th)", "Vietnamese(vi)", "Indonesian(id)", "Hindi(hi)", "Bulgarian(bg)",
		"Greek(el)", "Croatian(hr)", "Serbian(sr)", "Slovak(sk)", "Slovenian(sl)", "Estonian(et)",
		"Latvian(lv)", "Lithuanian(lt)"));
NAMESPACE_END(ChatTranslator)
